...
• Real-time оптимизация и обучение"""
    ...
    # === ИСПРАВЛЕНИЯ В МЕТОДЕ shutdown() ===
    async def shutdown(self):
        """Остановка"""
        logger.info("🛑 Shutting down bot...")

        # ✅ Исправление 1: Правильная структура try/except внутри цикла
        ...
        # ✅ Исправление 2: Этот лог должен быть ВНУТРИ метода (была ошибка отступа)
        logger.info("✅ Bot stopped")

    # === ИСПРАВЛЕНИЕ 3: Функция main() НЕ должна быть внутри класса ===
    # Она должна быть на уровне модуля (без отступа):
...
async def main():
    ...
    # === ИСПРАВЛЕНИЕ 4: Правильная проверка __name__ ===
    # Было: if name == "main":  ❌
    # Стало:
